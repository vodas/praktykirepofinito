...
class Model extends Component implements IteratorAggregate, ArrayAccess, Arrayable
{
    ...
    public function attributeLabels()
    {
                return [
                    ...
                    'nrHouse' => Yii::t('app', 'nrHouse'),
                    'nrFlat' => Yii::t('app', 'nrFlat'),
                   ...
                   'Search' => Yii::t('app', 'Search'),
                    ...
                    'user_info' => Yii::t('app', 'user_info'),
                    'restaurant_id' => Yii::t('app', 'restaurant_id'),
                   'order_info' => Yii::t('app', 'order_info'),
                    'status' => Yii::t('app', 'status'),
                    'other_users' => Yii::t('app', 'other_users'),
                    'Orders' => Yii::t('app', 'Orders'),
                    'Create Order' => Yii::t('app', 'Create Order'),
                    'pass_repeat' => Yii::t('app', 'pass_repeat'),
                    'description' => Yii::t('app', 'description'),
                    'product_id' => Yii::t('app', 'product_id'),
                   'Delete' => Yii::t('app', 'Delete'),
                    'zip_code' => Yii::t('app', 'zip_code'),
                    'house_nr' => Yii::t('app', 'house_nr'),
                   'flat_nr' => Yii::t('app', 'flat_nr'),
                    'review' => Yii::t('app', 'review'),
                   'review_id' => Yii::t('app', 'review_id'),
                    'Create Review' => Yii::t('app', 'Create Review'),
                    'price' => Yii::t('app', 'price'),
                    'warehouse_id' => Yii::t('app', 'warehouse_id'),
                    'Create Warehouse' => Yii::t('app', 'Create Warehouse'),
                    'pass' => Yii::t('app', 'pass'),
